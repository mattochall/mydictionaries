...
input("Press Enter to display next report")
...
for school in schools:
    ...
    if (
        ...
        if (
            ...
            print(f"University Name: {school['instnm']}")
            print(
                f"Total price for in-state students living off campus: ${school['Total price for in-state students living off campus (not with family)  2020-21 (DRVIC2020)']:,.0f}"
            )
            print()
            print()
